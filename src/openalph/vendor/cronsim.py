# VENDORED from https://github.com/cuu508/cronsim
# File: cronsim/cronsim.py @ commit 375c57a0dc725a636fbf8322bf90f8092f255330 (2025-10-21, last commit touching this file)
# License: BSD-3-Clause (c) 2021 Peteris Caune -- full text in LICENSE.cronsim (same dir)
# Vendored 2026-08-05 for kdsn.210.6 (calendar-scheduled timers). Core parser + forward
# iterator only -- explain.py is NOT vendored. 6-field seconds support is dormant here:
# openalph/schedule.py enforces the 5-field grammar. To update: diff against the pinned
# SHA above, re-run the A13 provenance test (tests/test_schedule.py).
